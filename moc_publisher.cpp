...
QT_MOC_LITERAL(1, 10, 12), // "relayChanges"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Publisher\0relayChanges\0"
};
...
void Publisher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->relayChanges((*reinterpret_cast< const QPointF(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Publisher::staticMetaObject = {
    { &Transmitter::staticMetaObject, qt_meta_stringdata_Publisher.data,
...
void *Publisher::qt_metacast(const char *_clname)
{
    ...
    return Transmitter::qt_metacast(_clname);
}

int Publisher::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Transmitter::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
